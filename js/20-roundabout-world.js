...
(function(){
  ...
  buildWorld=function(scene,onProgress){
    ...
    /* Remove every old road triangle inside the roundabout construction disc. */
    {
    ...
    /* Clear low rails/posts in the same compact construction discs. */
    ...
    /* Ten-band ribbon, matching the normal road style. */
    ...
    /* Keep terrain below the rebuilt circle/arms so no hillside pokes through. */
