...
/* Verdant remains v142. Aqua is a separate world: v143 builds the glass
   ...
   creature_jelly.gltf actors, and v153 replaces low-detail coral blobs with
   six recognizable coral geometries plus close hero LOD groups. */
if(typeof document!=='undefined'&&document.write){
  ...
  document.write('<script src="js/49-aqua-rift-v143.js?b=153"></script>');
  document.write('<script src="js/50-aqua-real-fish-v144.js?b=153"></script>');
  document.write('<script src="js/51-aqua-fish-visibility-v145.js?b=153"></script>');
  document.write('<script src="js/52-aqua-depth-distribution-v146.js?b=153"></script>');
  document.write('<script src="js/53-aqua-swim-motion-v147.js?b=153"></script>');
  document.write('<script src="js/54-aqua-tail-animation-v148.js?b=153"></script>');
  document.write('<script src="js/55-aqua-uturn-continuity-v149.js?b=153"></script>');
  document.write('<script src="js/56-aqua-faces-reef-v150.js?b=153"></script>');
  document.write('<script src="js/57-aqua-coral-jelly-v151.js?b=153"></script>');
  document.write('<script src="js/58-aqua-proper-jelly-reef-v152.js?b=153"></script>');
  document.write('<script src="js/59-aqua-hq-coral-v153.js?b=153"></script>');
