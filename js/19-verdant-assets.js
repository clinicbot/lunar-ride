...
/* Verdant remains v142. Aqua is a separate world: v143 builds the glass
   ...
   reef-only seafloor, v151 was the first coral/jelly enrichment, and v152
   rebuilds that layer as visible reef walls using the project's real shared
   creature_jelly.gltf actors. */
if(typeof document!=='undefined'&&document.write){
  ...
  document.write('<script src="js/49-aqua-rift-v143.js?b=152"></script>');
  document.write('<script src="js/50-aqua-real-fish-v144.js?b=152"></script>');
  document.write('<script src="js/51-aqua-fish-visibility-v145.js?b=152"></script>');
  document.write('<script src="js/52-aqua-depth-distribution-v146.js?b=152"></script>');
  document.write('<script src="js/53-aqua-swim-motion-v147.js?b=152"></script>');
  document.write('<script src="js/54-aqua-tail-animation-v148.js?b=152"></script>');
  document.write('<script src="js/55-aqua-uturn-continuity-v149.js?b=152"></script>');
  document.write('<script src="js/56-aqua-faces-reef-v150.js?b=152"></script>');
  document.write('<script src="js/57-aqua-coral-jelly-v151.js?b=152"></script>');
  document.write('<script src="js/58-aqua-proper-jelly-reef-v152.js?b=152"></script>');
