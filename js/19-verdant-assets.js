...
/* Stable route, v128 legacy mountain removal, v129 global anti-dome/roadbed,
   ...
   road-intruding plants. v130 adds optimized photogrammetry Hero/LOD palms
   after cleanup and before the existing GPU-instanced renderer uploads them. */
if(typeof document!=='undefined'&&document.write){
  document.write('<script src="js/20-verdant-route-audit.js?b=130"></script>');
  document.write('<script src="js/21-verdant-terrain-polish.js?b=130"></script>');
  document.write('<script src="js/35-verdant-mountains-v123.js?b=130"></script>');
  document.write('<script src="js/37-verdant-mountains-v129.js?b=130"></script>');
  document.write('<script src="js/25-verdant-lite-richness.js?b=130"></script>');
  document.write('<script src="js/26-verdant-real-nature.js?b=130"></script>');
  document.write('<script src="js/30-verdant-natural-v119.js?b=130"></script>');
  document.write('<script src="js/31-verdant-enrichment-v120.js?b=130"></script>');
  document.write('<script src="js/32-verdant-fauna-buildings-v121.js?b=130"></script>');
  document.write('<script src="js/33-verdant-terrain-birds-v122.js?b=130"></script>');
  document.write('<script src="js/34-verdant-assets-gate-v123.js?b=130"></script>');
  document.write('<script src="js/36-verdant-wildlife-v125.js?b=130"></script>');
  document.write('<script src="js/38-verdant-world-cleanup-v129.js?b=130"></script>');
  document.write('<script src="js/27-verdant-billboard-cleanup.js?b=130"></script>');
  document.write('<script src="js/39-verdant-photogrammetry-palms-v130.js?b=130"></script>');
  document.write('<script src="js/28-verdant-instanced-renderer.js?b=130"></script>');
}
